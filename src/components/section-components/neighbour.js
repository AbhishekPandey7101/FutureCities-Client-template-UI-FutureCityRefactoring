...
import img from '../assests/pic22.jpeg';
import img2 from '../assests/pic23.jpeg';
import img3 from '../assests/pic24.jpeg';
import img4 from '../assests/pic20.jpeg';
import img5 from '../assests/pic19.jpeg';
					...
					<div className="col-lg-12">
						<div className="ltn__neighbour-tab-wrap">
							<div className="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
								<div className="nav">
									<a className="active show" data-bs-toggle="tab" href="#liton_tab_4_1"><img src={img} alt="#" /></a>
									<a data-bs-toggle="tab" href="#liton_tab_4_2" ><img src={img2} alt="#" /></a>
									<a data-bs-toggle="tab" href="#liton_tab_4_3" ><img src={img3} alt="#" /></a>
								</div>
							</div>
											...
											<div className="col-lg-4">
												<div className="ltn__search-by-place-item neighbour-apartments-item">
													<div className="search-by-place-img">
														<Link to="/product-details"><img src={img5} alt="#" /></Link>
