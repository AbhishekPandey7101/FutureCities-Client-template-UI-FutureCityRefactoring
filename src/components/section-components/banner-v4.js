...
import img from '../assests/pic30.jpeg';
	...
	render() {
		...
		return <div className="ltn__slider-area ltn__slider-2--- ltn__slider-6 section-bg-2">
			<div className="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white">
				{/* ltn__slide-item */}
				<div className="ltn__slide-item ltn__slide-item-2--- ltn__slide-item-6 text-color-white bg-image bg-overlay-theme-black-60" data-bs-bg={img}>
