...
import img4 from '../assests/pic10.jpeg';
import img5 from '../assests/pic12.jpeg';
import img6 from '../assests/pic11.jpeg';
				...
				<div className="container-fluid">
					...
					<div className="row ltn__product-slider-item-four-active-full-width slick-arrow-1">
						...
						<div className="col-lg-12">
							<div className="ltn__product-item ltn__product-item-4 text-center---">
								<div className="product-img go-top">
									<Link to="/product-details"><img src={img4} alt="#" /></Link>
								...
								<div className="product-info-bottom">
									<div className="real-estate-agent">
										<div className="agent-img go-top">
											<Link to="/team-details"><img src={img4} alt="#" /></Link>
										</div>
						...
						<div className="col-lg-12">
			                ...
			                square Ft
								...
								<div className="product-info-bottom">
									<div className="real-estate-agent">
										<div className="agent-img go-top">
											<Link to="/team-details"><img src={img5} alt="#" /></Link>
										</div>
										<div className="agent-brief go-top">
											<h6><Link to="/team-details">William Seklo</Link></h6>
											<small>Estate Agents</small>
						...
						<div className="col-lg-12">
							<div className="ltn__product-item ltn__product-item-4 text-center---">
								<div className="product-img go-top">
									<Link to="/product-details"><img src={img6} alt="#" /></Link>
									<div className="product-badge">
										<ul>
											<li className="sale-badge bg-green">For Rent</li>
										</ul>
