...
import img from '../assests/pic16.jpeg';
import img2 from '../assests/sub2.jpeg';
import img3 from '../assests/sub1.jpeg';

import img4 from '../assests/sub3.jpeg';
import img5 from '../assests/pic29.png';
					...
					<div className="ltn__slider-11-img-slide-arrow-inner">
						<div className="ltn__slider-11-img-slide-arrow-active">
							<div className="image-slide-item">
								<img src={img2} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={img3} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={img4} alt="Flower Image" />
							</div>
							<div className="image-slide-item">
								<img src={img2} alt="Flower Image" />
							</div>
