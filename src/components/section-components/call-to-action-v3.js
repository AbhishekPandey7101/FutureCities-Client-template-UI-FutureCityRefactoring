...
import img from '../assests/pic27.jpeg';
import img1 from '../assests/pic10.jpeg';
class CallToActonV3 extends Component {
	...
	render() {
		...
		return <div className="ltn__call-to-action-area ltn__call-to-action-4 bg-image pt-115 pb-120 mb-120" data-bs-bg={img1}>
