...
import img from '../assests/pic18.jpeg';
import img1 from '../assests/pic19.jpeg';
import img2 from '../assests/pic20.jpeg';
import img3 from '../assests/x.jpeg';
			...
			<div className="container">
				...
				<div className="row ltn__search-by-place-slider-1-active slick-arrow-1 go-top">
					<div className="col-lg-4">
						<div className="ltn__search-by-place-item">
							<div className="search-by-place-img">
								<Link to="/product-details"><img src={img} alt="#" /></Link>
					...
					<div className="col-lg-4">
						<div className="ltn__search-by-place-item">
							<div className="search-by-place-img">
								<Link to="/product-details"><img src={img1} alt="#" /></Link>
								<div className="search-by-place-badge">
									<ul>
										<li>5 Properties</li>
									</ul>
					...
					<div className="col-lg-4">
						<div className="ltn__search-by-place-item">
							<div className="search-by-place-img">
								<Link to="/product-details"><img src={img2} alt="#" /></Link>
								<div className="search-by-place-badge">
									<ul>
										<li>9 Properties</li>
									</ul>
					...
					<div className="col-lg-4">
						<div className="ltn__search-by-place-item">
							<div className="search-by-place-img">
								<Link to="/product-details"><img src={img3} alt="#" /></Link>
								<div className="search-by-place-badge">
									<ul>
										<li>5 Properties</li>
									</ul>
