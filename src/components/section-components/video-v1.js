...
import img from '../assests/pic13.jpeg';
class VideoV1 extends Component {
	...
	render() {
		...
		return <div className="ltn__video-popup-area ltn__video-popup-margin---">
			<div className="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1" data-bs-bg={img}>
