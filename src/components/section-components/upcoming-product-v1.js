...
import img from '../assests/pic17.jpeg';
import img1 from '../assests/pic30.jpeg';
...
class UpcomingProductV1 extends Component {
	...
	render() {
		...
		return <div className="ltn__upcoming-project-area section-bg-1--- bg-image-top pt-115 pb-65" data-bs-bg={img1}>
								...
								<div className="col-lg-5 section-bg-1">
									<div className="ltn__upcoming-project-info ltn__menu-widget">
										...
										<div className="btn-wrapper animated go-top">
											<a href="Resume.pdf"
												download="Resume.pdf">
												<button className=" theme-btn-1 btn btn-effect-1">Download Brouchure</button>
											</a>
										</div>
									</div>
								</div>
