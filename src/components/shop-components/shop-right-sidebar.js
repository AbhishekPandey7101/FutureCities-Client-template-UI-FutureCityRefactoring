...
class ShopGridV1 extends Component {
  render() {
    ...
    let housingComplexData = [
      {
        mainImage: "https://miro.medium.com/max/1400/1*Qkw0cchY8tAa7zNE8Jz5Lg.jpeg",
        saleBadge: "FOR SALE",
        applicationFee: "R200",
        name: "SOME NAME",
        address: "SOME ADDRESS LINE 1",
        agentImageUrl: "https://miro.medium.com/max/1400/1*JUcVPZPzBFuDHmOXKyj_JA.jpeg",
        agentName: "Agent Name",
        agentAbout: "Some dummy info",
        agentSocialLinks: {
          fb: "/",
          linkedIn: "",
          youtube: "",
                  ...
                  >
                    <div className="ltn__product-tab-content-inner ltn__product-grid-view">
                      <div className="row">
                        ...
                        {/* ltn__product-item */}
						{housingComplexData.map((housingComplex) => {
                          return (<div className="col-xl-6 col-sm-6 col-12">
                          <div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                            <div className="product-img go-top">
                              <Link to="/product-details">
                                <img
                                  src={housingComplex.mainImage}
                                  alt="#"
                                />
                              </Link>
                            ...
                            <div className="product-info">
                              <div className="product-badge">
                                <ul>
                                  <li className="sale-badg">{housingComplex.saleBadge}</li>
                                </ul>
                              </div>
